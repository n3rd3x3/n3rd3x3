# Generated by Powerlevel10k configuration wizard on 2021-12-02 at 14:01 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19497.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, round heads, slanted tails, 2 lines, disconnected, left frame,
...
# add special icons
function prompt_my_icons() {
	p10k segment -b white -f blue -i '' -t '%n'
	p10k segment -b blue -f white -i '' -t '%m'
}
